...
- **Attach one photo** — `creators/zion-clark/refs/zion_gym_parallette.jpg` is the best all-purpose
  identity shot (clear face, chest/arm tattoo, gym setting).
- If the scene is specifically about a tattoo or a different body context, swap in the more
  relevant photo instead: `zion_chest_arm_tattoo.jpg` (chest/arm ink), `zion_back_noexcuses_tattoo.jpg`
  (back tattoo scenes), `zion_track_noexcuses.jpg` (track/wheelchair), `zion_boxing_ring.jpg`
  (WWE/combat).
