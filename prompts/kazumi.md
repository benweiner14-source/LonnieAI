...
Now render: long balayage waves with neon streaks, full glam, gold jade pendant, on a high walkway among towering megabuildings at night, teal-and-magenta city glow, a few distant light trails in the canyon below — clean, uncluttered composition — the entire frame rendered in the CGI style described above. Camera: eye-level angle, 24mm wide lens, subject small within the frame, the megabuilding canyon and light trails stretching into the distance behind her. No real game, studio, or brand logos or trademarks anywhere in the output. 9:16 vertical. Neo City. SFW.
```
