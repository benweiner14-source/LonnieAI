# Creator Profile — Zion Clark

- **Instagram:** [@zionclark](https://instagram.com/zionclark) (~1M followers)
- **Who:** Elite adaptive athlete — wrestler, MMA fighter, and wheelchair racer. Born with
  **caudal regression syndrome** (born without legs). Guinness World Record holder,
  motivational speaker, author. Foster-care-to-champion story.
...
> and signature poses. Until then, prompts describe him at the level above.

## Styles (sports-game realism — "less artsy, grounded")
- **NBA 2K** (`skills/nba2k-style/`) — clean 2K Sports cutscene render for gym + track.
- **WWE 2K** (`skills/wwe2k-style/`) — theatrical entrance/ring drama for hero moments.
