...
- **Nano Banana Pro needs more explicit/redundant instruction than GPT Image 2 to land the same
  ...
  models found GPT-2 nailed the arm-blocks-the-phone framing natively (arm/sleeve filling most of
  ...
  faithful model would require. Describe the arm and sleeve as filling a large part of the
  foreground, soft and slightly out of focus from proximity to the lens — this gives the "phone
  never visible" rule a physical/optical reason, not just a bare negation.
